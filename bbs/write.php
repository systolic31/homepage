...
?>
<br /><br /><br />
<div id="editor_wrap" style="width:100%;text-align:center;">
    <form name="tx_editor_form" id="tx_editor_form" action="http://localhost:81/bbs/write_check.php" method="post" accept-charset="utf-8">
    <div id="subject_wrap" style="margin:10px 10px;">Subject: <input name="subject" type="text" size="80"></div>
        <!-- 에디터 컨테이너 시작 -->
        <div id="tx_trex_container" class="tx-editor-container" style="display:inline-block;">
            <!-- 사이드바 -->
...
<div id="write_save_button" style="text-align: center;">
<div style="display: inline-block;"><button onclick='saveContent()' style="width:100px;"> Save </button></div>
        </div>
<?php
